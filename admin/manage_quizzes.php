...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create'])) {
    ...
    $stmt->bind_param("ssissiiiii", $title, $description, $category_id, $difficulty, $time_per_question, $pass_score, $shuffle, $show_answers, $is_active, $created_by);
...
$quizzes = $conn->query("SELECT q.*, c.name as category_name, u.full_name as creator,
...
if (isset($_GET['edit'])) {
    ...
    $edit_quiz = $conn->query("SELECT * FROM quizzes WHERE id = $edit_id")->fetch_assoc();
}
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>สร้างชุดข้อสอบ - <?php echo SITE_NAME; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="manage_quizzes.php" class="menu-item active">
                📝 สร้างชุดข้อสอบ
            </a>
    ...
    <div class="main-content">
        ...
        <!-- รายการชุดข้อสอบ -->
        <div class="section">
            <h2 style="margin-bottom: 20px;">📚 ชุดข้อสอบทั้งหมด</h2>
